    ...
    function AddSubject () {
        ...
        const [nbHeureIsValid, setNbHeureIsValid] = useState('form-control is-invalid');
                                        ...
                                        <Row className="add-subject">
                                            ...
                                            <Col xs={12} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Control className={formationIsValid} as="select" onChange={handleFormation}>
                                                        <option disabled selected value>Choose a formation</option>	
                                            ...
                                            <Col xs={12} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Control className={levelIsValid} as="select" onChange={handleLevel}>
                                            ...
                                            <Col xs={12} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Control className={coefIsValid} type="text" min="0" onKeyDown={blockInvalidChar}
                                                        onChange={handleCoef}/>    
                                                </Form.Group>
                                            </Col>
                                            ...
                                            <Col xs={12} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Control className={nbHeureIsValid} type="text" min="0" onKeyDown={blockInvalidChar}
