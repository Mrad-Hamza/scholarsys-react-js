...
class EditLevel extends React.Component {
    constructor(props) {
        ...
        this.state.fields["name"] = "Data Science";
        this.state.fields["acronyme"] = "ds";
        ...
        return (
            <div>
                <div className="page-header">
                    <Row>
                        <Col sm={12}>
                            <h3 className="page-title">Edit Level</h3>
                            <ul className="breadcrumb">
                                <li className="breadcrumb-item"><a href="/formations">Levels</a></li>
                        ...
                        <Card>
                            <Card.Body>
                                <Form onSubmit= {this.contactSubmit.bind(this)}>
                                    <Row>
                                        <Col sm={12}>
                                            <h5 className="form-title"><span>Levels Details</span></h5>
                                        </Col>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                onChange={this.handleChange.bind(this, "acronyme")}
