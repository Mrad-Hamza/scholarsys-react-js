...
class EditGrade extends React.Component {
    constructor(props) {
        ...
        this.state.fields["type"] = "DS";
        this.state.fields["formation"] = "DataScience";
        this.state.fields["niveau"] = "4";
        this.state.fields["matiere"] = "TLA";
        this.state.fields["class"] = '2';
        this.state.fields["etudiant"] = 'Louay';
        this.state.fields["prof"] = 'Achref';
        this.state.fields["date"] = '21/03/1998';
